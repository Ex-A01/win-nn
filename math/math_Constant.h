#ifndef NN_MATH_MATH_CONSTANT_H_
#define NN_MATH_MATH_CONSTANT_H_
...
const f32 F_MAX     = FLT_MAX;              // Maximum positive value = 3.40282346638529 * 10^38
const f32 F_MIN     = FLT_MIN;              // Minimum positive value = 1.17549435082229 * 10^-38


#ifdef __ARMCC_VERSION
// Definitions that use the extended features of the ARM compiler.
const f32 F_NAN     = 0f_7FFFFFFF;    // Non-numbers.
const f32 F_INF     = 0f_7F800000;    // ∞
const f32 F_NINF    = 0f_FF800000;    // -∞
const f32 F_ULP     = 0f_34000000;    // The minimum positive value that satisfies 1.0f + x != 1.0f.
...
const f32 F_INF     = *reinterpret_cast<const f32*>(&internal::I_INF);    // ∞
const f32 F_NINF    = *reinterpret_cast<const f32*>(&internal::I_NINF);   // -∞
const f32 F_ULP     = *reinterpret_cast<const f32*>(&internal::I_ULP);    // The minimum positive value that satisfies 1.0f + x != 1.0f.

#endif // __ARMCC_VERSION

}}  // nn::math

/* NN_MATH_MATH_CONSTANT_H_ */
#endif
