...
@param[out] pOut  Pointer to the buffer that receives the calculation results. The same quaternion may be specified for both q1 and q2.
...
@param[out] pOut  Pointer to the buffer that receives the calculation results. May point to the same quaternion as q.
